            ...
            if (messageType) {
                switch(messageType) {
                    ...
                    case 'PRODUCT':
                        ...
                        const productMsg = await Utils_1.createMessagePayload(jid, productContent, { quoted });
                    ...
                    case 'INTERACTIVE':
                        ...
                        const interactiveMsg = await Utils_1.createMessagePayload(jid, interactiveContent, { quoted });
